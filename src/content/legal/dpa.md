...
1. **Processing Instructions**: The Processor agrees to process personal data only wood-500d on documented instructions from the Controller, unless required to do so by law.
